#'https://github.com/caijun/geoChina/blob/master/R/conv.R
#'#distm(c(104.087962,30.660716), c(104.082225,30.65485), fun = distHaversine)
#'geoChina::conv(30.660716,104.087962,from = "BD-09",to = "GCJ-02")
#'geoChina::conv(30.660716,104.087962,from = "BD-09",to = "WGS-84")
#' Convert coordinates
#'
